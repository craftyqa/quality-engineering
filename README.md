...
- Browse by topic in [`resources/`](resources/).
- Add links with a one-line note on *why* it matters to you.
- Prefer stable URLs (official docs, org sites); use archive links for fragile pages when you care about long-term access.

## Contents

| Topic | File |
|--------|------|
| Skills & competencies | [`resources/skills-and-competencies.md`](resources/skills-and-competencies.md) |
| Learning paths | [`resources/learning-paths.md`](resources/learning-paths.md) |
| Roadmaps | [`resources/roadmaps.md`](resources/roadmaps.md) |
...
When you find something worth saving, drop a stub in [`resources/inbox.md`](resources/inbox.md) and sort it into the right file when you have time.
